...
favoriteThings.car = 'QX80'

favoriteThings.show = 'Outlander'
...
let wizard1 = new Wizard('Gandalf', '350', 'Bippity Boppity Boop!')
...
let phone1 = new Phone('Iphone', '13', 64, 'Grey', 1000)
let phone2 = new Phone('Android', 'Note', 85, 'Lilac', 890)
let phone3 = new Phone('Motorola', 'version2', 50, 'Black', 350)
...
let myFirstVehicle = new Vehicle(5, 'white', 199);
...
let myFirstMotorcycle = new Motorcycle(2, 'red', 606, 'volcan900')
...
let myFirstBoat = new Boat(6, 'Black', 777, `The Kraken`, 'Sloop', false)
